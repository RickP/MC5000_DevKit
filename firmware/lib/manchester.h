...
// Manchester encoding via pre-generated static tables to save memory
// and use flash instead

#include <stdint.h>

const uint16_t me_encode_tab[128] = {
...
const uint8_t me_decode_tab[256] = {
...
// Encode 8 bits into 16 manchester-encoded bits
uint16_t me_encode(uint8_t c) {
    return me_encode_tab[c];
}

// Decode 8 manchester-encoded bits into a nibble
uint8_t me_decode8(uint8_t m) {
